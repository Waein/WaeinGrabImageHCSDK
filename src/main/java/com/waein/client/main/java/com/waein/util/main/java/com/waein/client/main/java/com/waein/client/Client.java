package com.waein.client.main.java.com.waein.util.main.java.com.waein.client.main.java.com.waein.client;
...
import com.waein.client.main.java.com.waein.util.main.java.com.waein.client.main.java.com.waein.callback.DecCBFunCallBack;
import com.waein.client.main.java.com.waein.util.main.java.com.waein.client.main.java.com.waein.sdk.HCNetSDK;
import com.waein.client.main.java.com.waein.util.main.java.com.waein.client.main.java.com.waein.sdk.PlayCtrl;
import com.waein.client.main.java.com.waein.util.main.java.com.waein.client.main.java.com.waein.util.Time;
...
public class Client {
    ...
    static HCNetSDK hCNetSDK = HCNetSDK.INSTANCE;//海康网络SDK封装
    static PlayCtrl playControl = PlayCtrl.INSTANCE;//播放控制器
    ...
    private String m_sDeviceIP = "192.168.0.216";//已登录设备的IP地址
    private int port = 80;//端口
    private String userName = "admin";//登陆名
    private String password = "12345";//登陆密码
    ...
    private DecCBFunCallBack decCBFunCallBack;
    ...
    public Client() {
        ...
        decCBFunCallBack = new DecCBFunCallBack();
        m_iTreeNodeNum = 0;
    }
